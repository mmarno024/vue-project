...
export declare function getOptionStyle(option: Select2Option, hoveringValue: Select2Value | null | undefined): string;
export declare function getDropdownStyle(isOpen: boolean): "select2-container select2-container--default select2-container-dropdown select2-container--open" | "select2-container select2-container--default select2-container-dropdown";
export declare function getContainerStyle(disabled: boolean | undefined, isOpen: boolean): string;
export declare function getSelectionStyle(multiple?: boolean | undefined): string;
export declare function isSearchboxHiddex(data: Select2Data, minCountForSearch?: number): boolean;
export declare function getSearchStyle(isHidden: boolean): "select2-search select2-search--dropdown select2-search--hide" | "select2-search select2-search--dropdown";
export declare function isSelected(options: Select2Option | Select2Option[] | null, option: Select2Option, multiple: boolean | null | undefined): "true" | "false";
export declare function removeSelection(options: Select2Option | Select2Option[] | null, option: Select2Option): void;
