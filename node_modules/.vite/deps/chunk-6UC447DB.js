 ...
 - ${i4}: ${e4}`, h2 && (l2 += encodeURI(i4) + "=" + encodeURI(e4));
          ...
          return t3.forEach((t4) => {
            if (t4.length > 1)
              for (o2 = s2 = t4.length - 1; o2 > 0; o2--)
                (r2 = t4[o2] - t4[o2 - 1]) < 0 && !n2 ? (e3 == null ? void 0 : e3(), e3 = void 0) : r2 && (void 0 === i3 || r2 < i3) && (i3 = r2);
          }), i3;
          ...
          setTickPositions() {
            ...
            if (this.tickmarkOffset = this.categories && "between" === t3.tickmarkPlacement && 1 === this.tickInterval ? 0.5 : 0, this.minorTickInterval = "auto" === s2 && this.tickInterval ? this.tickInterval / t3.minorTicksPerMajor : s2, this.single = this.min === this.max && y(this.min) && !this.tickAmount && (this.min % 1 == 0 || false !== t3.allowDecimals), e3)
              ...
              if (!((_a = this.ordinal) == null ? void 0 : _a.positions) && (this.max - this.min) / this.tickInterval > Math.max(2 * this.len, 200))
                ...
                a2 = this.getTimeTicks(this.dateTime.normalizeTimeTickInterval(this.tickInterval, t3.units), this.min, this.max, t3.startOfWeek, (_b = this.ordinal) == null ? void 0 : _b.positions, this.closestPointRange, true);
        ...
        function S() {
          ...
          a2 && [s2, "-" + s2].forEach((i4) => {
            ...
            for (; s3--; )
              n3 = o2[s3], t3 = e3.getStackIndicator(t3, n3, e3.index, i4), h2 = (_a = r2[i4]) == null ? void 0 : _a[n3], (l2 = h2 == null ? void 0 : h2.points[t3.key || ""]) && a2.call(e3, l2, h2, s3);
          });
        }
        function C(t3, e3, i3) {
        ...
        return function(t3) {
          ...
          function x(t4) {
            ...
            h(this, "drawDataLabels"), ((_a = i4.hasDataLabels) == null ? void 0 : _a.call(i4)) && (e4 = this.initDataLabels(k), t4.forEach((t5) => {
              ...
              let c3 = r2.length;
              for (; c3--; )
                r2[c3] && r2[c3].isActive ? r2[c3].isActive = false : ((_b = r2[c3]) == null ? void 0 : _b.destroy(), r2.splice(c3, 1));
...
//# sourceMappingURL=chunk-6UC447DB.js.map
