      ...
      i(e, "Extensions/Pane/PaneComposition.js", [e["Core/Utilities.js"]], function(t2) {
          ...
          render() {
            ...
            if (s2) {
              ...
              for (let e4 = 0; e4 < t4; e4++)
                s2[e4] && this.axis ? this.renderBackground(a(i2.background, s2[e4]), e4) : this.background[e4] && (this.background[e4] = this.background[e4].destroy(), this.background.splice(e4, 1));
            }
          }
        ...
        class f extends a {
          ...
          drawDataLabels() {
            ...
            if (h2) {
              if (d(h2) ? (s2 = h2[0] || { enabled: false }, o2 = h2[1] || { enabled: false }) : ((s2 = p({}, h2)).x = h2.xHigh, s2.y = h2.yHigh, (o2 = p({}, h2)).x = h2.xLow, o2.y = h2.yLow), s2.enabled || ((_a = this.hasDataLabels) == null ? void 0 : _a.call(this))) {
                ...
                for (this.options.dataLabels = s2, r.drawDataLabels && r.drawDataLabels.apply(this, arguments), t3 = n2; t3--; )
                  (e3 = a2[t3]) && (e3.dataLabelUpper = e3.dataLabel, e3.dataLabel = l2[t3], delete e3.dataLabels, e3.y = e3.low, e3.plotY = e3._plotY);
              }
              ...
              if (s2.enabled)
                for (t3 = n2; t3--; )
                  (e3 = a2[t3]) && (e3.dataLabels = [e3.dataLabelUpper, e3.dataLabel].filter(function(t4) {
                    return !!t4;
                  }));
          ...
          drawPoints() {
            ...
            for (r.drawPoints.apply(this, arguments), this.restoreMarkerSettings(s2), t3 = 0; t3 < i3; )
              (e3 = this.points[t3]).graphics = e3.graphics || [], e3.origProps = { plotY: e3.plotY, plotX: e3.plotX, isInside: e3.isInside, negative: e3.negative, zone: e3.zone, y: e3.y }, (e3.graphic || e3.graphics[0]) && (e3.graphics[0] = e3.graphic), e3.graphic = e3.graphics[1], e3.plotY = e3.plotHigh, h(e3.plotHighX) && (e3.plotX = e3.plotHighX), e3.y = u(e3.high, e3.origProps.y), e3.negative = e3.y < (this.options.threshold || 0), this.zones.length && (e3.zone = e3.getZone()), this.chart.polar || (e3.isInside = e3.isTopInside = void 0 !== e3.plotY && e3.plotY >= 0 && e3.plotY <= this.yAxis.len && e3.plotX >= 0 && e3.plotX <= this.xAxis.len), t3++;
            for (r.drawPoints.apply(this, arguments), t3 = 0; t3 < i3; )
              (e3 = this.points[t3]).graphics = e3.graphics || [], (e3.graphic || e3.graphics[1]) && (e3.graphics[1] = e3.graphic), e3.graphic = e3.graphics[0], e3.origProps && (p(e3, e3.origProps), delete e3.origProps), t3++;
          }
        ...
        return f.defaultOptions = g(a.defaultOptions, { lineWidth: 1, threshold: null, tooltip: { pointFormat: '<span style="color:{series.color}">●</span> {series.name}: <b>{point.low}</b> - <b>{point.high}</b><br/>' }, trackByArea: true, dataLabels: { align: void 0, verticalAlign: void 0, xLow: 0, xHigh: 0, yLow: 0, yHigh: 0 } }), l(f, "afterTranslate", function() {
          ...
          this.points.forEach((t3) => {
            if (this.chart.polar)
              this.highToXY(t3), t3.plotLow = t3.plotY, t3.tooltipPos = [((t3.plotHighX || 0) + (t3.plotLowX || 0)) / 2, ((t3.plotHigh || 0) + (t3.plotLow || 0)) / 2];
            else {
        ...
        function u(t3) {
          ...
          for (n2 = 0; n2 < s2; n2++)
            if (a2 = e3[n2].legendItem || {}, r2 = (e3[n2 + 1] || {}).legendItem || {}, a2.labelHeight && (e3[n2].itemHeight = a2.labelHeight), e3[n2] === e3[s2 - 1] || a2.y !== r2.y) {
          ...
          ("xAxis" === e3 || "yAxis" === e3) && (this.series.forEach((t4) => {
            if (t4.bubblePadding && t4.reserveSpace()) {
              ...
              if (i3 && ((t4.onPoint || t4).getRadii(0, 0, t4), t4.onPoint && (t4.radii = t4.onPoint.radii)), a2 > 0) {
                let i4 = e4.length;
                for (; i4--; )
                  if (m(e4[i4]) && this.dataMin <= e4[i4] && e4[i4] <= this.max) {
        ...
        class M extends d {
          ...
          getRadii() {
            ...
            for (o2 = 0, s2 = t3.length; o2 < s2; o2++)
              a2 = t3[o2], i3.push(this.getRadius(r2.zMin, r2.zMax, n2, l2, a2, e3 && e3[o2]));
            this.radii = i3;
          }
          getRadius(t3, e3, i3, s2, o2, a2) {
            ...
            if (null === a2 || null === o2)
              return null;
            if (m(o2)) {
              if (r2.sizeByAbsoluteValue && (o2 = Math.abs(o2 - l2), e3 = h2 = Math.max(e3 - l2, Math.abs(t3 - l2)), t3 = 0), o2 < t3)
                return i3 / 2 - 1;
              h2 > 0 && (p2 = (o2 - t3) / h2);
            }
        ...
        class g extends a {
          ...
          afterColumnTranslate() {
            ...
            this.points.forEach((g2) => {
              ...
              if (d(y) && d(m)) {
                if (g2.plotHigh = h(y, -p2, p2), g2.plotLow = h(m, -p2, p2), s2 = g2.plotHigh, Math.abs(t3 = u(g2.rectPlotY, g2.plotY) - g2.plotHigh) < b ? (e3 = b - t3, t3 += e3, s2 -= e3 / 2) : t3 < 0 && (t3 *= -1, s2 -= t3), l2 && this.polar)
                  i3 = g2.barX + r2, g2.shapeType = "arc", g2.shapeArgs = this.polar.arc(s2 + t3, s2, i3, i3 + g2.pointWidth);
                else {
                  f.height = t3, f.y = s2;
        ...
        class h extends t2 {
          ...
          drawDataLabels() {
            ...
            if (a)
              for (let e3 of (a.prototype.drawDataLabels.call(this), this.points))
                e3.y = e3[t3];
          }
          toYData(t3) {
            return [t3.low, t3.high];
        ...
        function p() {
          ...
          if (this.graphLayoutsLookup) {
            for (s(false, this), this.graphLayoutsLookup.forEach((t4) => t4.start()); !t3; )
              t3 = true, this.graphLayoutsLookup.forEach(i3);
        ...
        return class extends s {
          ...
          firePointEvent() {
            ...
            if (this.isParentNode && t3.parentNode) {
              ...
              e2.prototype.firePointEvent.apply(this, arguments);
          }
          select() {
        ...
        return { barycenter: function() {
          ...
          for (let a of o)
            this.options.splitSeries && !a.isParentNode ? (t3 = a.series.parentNode.plotX, e3 = a.series.parentNode.plotY) : (t3 = s.width / 2, e3 = s.height / 2), a.fixedPosition || (a.plotX -= (a.plotX - t3) * i3 / (a.mass * Math.sqrt(o.length)), a.plotY -= (a.plotY - e3) * i3 / (a.mass * Math.sqrt(o.length)));
          ...
          updateMassAndCenter() {
            ...
            if (this.isInternal) {
              for (let s of this.nodes)
                s.isEmpty || (t3 += s.mass, e2 += s.plotX * s.mass, i2 += s.plotY * s.mass);
              e2 /= t3, i2 /= t3;
            } else
              this.body && (t3 = this.body.mass, e2 = this.body.plotX, i2 = this.body.plotY);
        ...
        return class {
          ...
          insertNodes(t3) {
            for (let e2 of t3)
              this.root.insert(e2, this.maxDepth);
          }
        ...
        class c {
          ...
          step() {
            let t3 = this.series;
            for (let t4 of (this.currentStep++, "barnes-hut" === this.approximation && (this.createQuadTree(), this.quadTree.calculateMassAndCenter()), this.forces || []))
              this[t4 + "Forces"](this.temperature);
          ...
          initPositions() {
            ...
            if (h(t3))
              for (let e3 of (t3.call(this), this.nodes))
                l(e3.prevX) || (e3.prevX = e3.plotX), l(e3.prevY) || (e3.prevY = e3.plotY), e3.dispX = 0, e3.dispY = 0;
            else
              "circle" === t3 ? this.setCircularPositions() : this.setRandomPositions();
          }
          setCircularPositions() {
            ...
            let e3 = this.box, i3 = this.nodes, s2 = 2 * Math.PI / (i3.length + 1), o2 = i3.filter(function(t4) {
              ...
              for (let e4 of t4.linksFrom || [])
                a2[e4.toNode.id] || (a2[e4.toNode.id] = true, l2.push(e4.toNode), n2(e4.toNode));
            }, l2 = [];
            for (let t4 of o2)
              l2.push(t4), n2(t4);
            if (l2.length)
              for (let t4 of i3)
                -1 === l2.indexOf(t4) && l2.push(t4);
            else
              l2 = i3;
            for (let i4 = 0, o3 = l2.length; i4 < o3; ++i4)
              (t3 = l2[i4]).plotX = t3.prevX = d(t3.plotX, e3.width / 2 + r2 * Math.cos(i4 * s2)), t3.plotY = t3.prevY = d(t3.plotY, e3.height / 2 + r2 * Math.sin(i4 * s2)), t3.dispX = 0, t3.dispY = 0;
          }
          setRandomPositions() {
            let t3;
            ...
            for (let a2 = 0, r2 = i3.length; a2 < r2; ++a2)
              (t3 = i3[a2]).plotX = t3.prevX = d(t3.plotX, e3.width * o2(a2)), t3.plotY = t3.prevY = d(t3.plotY, e3.height * o2(s2 + a2)), t3.dispX = 0, t3.dispY = 0;
          }
          force(t3, ...e3) {
          ...
          getBarycenter() {
            let t3 = 0, e3 = 0, i3 = 0;
            for (let s2 of this.nodes)
              e3 += s2.plotX * s2.mass, i3 += s2.plotY * s2.mass, t3 += s2.mass;
          ...
          repulsiveForces() {
            if ("barnes-hut" === this.approximation)
              for (let t3 of this.nodes)
                this.quadTree.visitNodeRecursive(null, (e3) => this.barnesHutApproximation(t3, e3));
            else {
              let t3, e3, i3;
              for (let s2 of this.nodes)
                for (let o2 of this.nodes)
                  s2 === o2 || s2.fixedPosition || (i3 = this.getDistXY(s2, o2), 0 !== (e3 = this.vectorLength(i3)) && (t3 = this.repulsiveForce(e3, this.k), this.force("repulsive", s2, t3 * o2.mass, i3, e3)));
            }
          }
          attractiveForces() {
            let t3, e3, i3;
            for (let s2 of this.links)
              s2.fromNode && s2.toNode && (t3 = this.getDistXY(s2.fromNode, s2.toNode), 0 !== (e3 = this.vectorLength(t3)) && (i3 = this.attractiveForce(e3, this.k), this.force("attractive", s2, i3, t3, e3)));
          }
          applyLimits() {
            for (let t3 of this.nodes)
              t3.fixedPosition || (this.integration.integrate(this, t3), this.applyLimitBox(t3, this.box), t3.dispX = 0, t3.dispY = 0);
          }
          applyLimitBox(t3, e3) {
            let i3 = t3.radius;
        ...
        class l extends i2 {
          ...
          setCircularPositions() {
            ...
            for (let l2 of e3)
              this.options.splitSeries && !l2.isParentNode ? (o2 = l2.series.parentNode.plotX, r2 = l2.series.parentNode.plotY) : (o2 = t3.width / 2, r2 = t3.height / 2), l2.plotX = l2.prevX = a(l2.plotX, o2 + s2 * Math.cos(l2.index || n2 * i3)), l2.plotY = l2.prevY = a(l2.plotY, r2 + s2 * Math.sin(l2.index || n2 * i3)), l2.dispX = 0, l2.dispY = 0, n2++;
          }
          repulsiveForces() {
            let t3, e3, i3;
        ...
        function l(t3, e3) {
          ...
          if (t3 = t3 || h2 && h2.path, h2 && h2.undo(), t3 && d) {
            ...
            l2.attr({ dx: 0, dy: 0 }), delete l2.textPath;
        ...
        class A extends f {
          ...
          accumulateAllPoints() {
            ...
            for (let s2 of e3.series)
              if (s2.is("packedbubble") && s2.reserveSpace()) {
                t3 = s2.yData || [];
                for (let e4 = 0; e4 < t3.length; e4++)
                  i3.push([null, null, t3[e4], s2.index, e4, { id: e4, marker: { radius: 0 } }]);
              }
            return i3;
          }
          addLayout() {
          ...
          placeBubbles(t3) {
            ...
            if (p2.length) {
              if (s2.push([[0, 0, p2[0][2], p2[0][3], p2[0][4]]]), p2.length > 1)
                for (s2.push([[0, 0 - p2[1][2] - p2[0][2], p2[1][2], p2[1][3], p2[1][4]]]), h2 = 2; h2 < p2.length; h2++)
                  p2[h2][2] = p2[h2][2] || 1, e3(n2 = i3(s2[o2][a2], s2[o2 - 1][r2], p2[h2]), s2[o2][0]) ? (s2.push([]), r2 = 0, s2[o2 + 1].push(i3(s2[o2][a2], s2[o2][0], p2[h2])), o2++, a2 = 0) : o2 > 1 && s2[o2 - 1][r2 + 1] && e3(n2, s2[o2 - 1][r2 + 1]) ? (r2++, s2[o2].push(i3(s2[o2][a2], s2[o2 - 1][r2], p2[h2])), a2++) : (a2++, s2[o2].push(n2));
          ...
          resizeRadius() {
            ...
            for (let a3 of (t3 = i3 = Number.POSITIVE_INFINITY, e3 = s2 = Number.NEGATIVE_INFINITY, r2))
              o2 = a3[2], t3 = n2(t3, a3[0] - o2), e3 = l2(e3, a3[0] + o2), i3 = n2(i3, a3[1] - o2), s2 = l2(s2, a3[1] + o2);
            ...
            if (Math.abs(f2 - 1) > 1e-10) {
              ...
              a2.diffY = d2 / 2 + p2 - i3 - (s2 - i3) / 2, a2.diffX = c2 / 2 + h2 - t3 - (e3 - t3) / 2;
          }
          seriesBox() {
            let t3;
          ...
          translate() {
            ...
            for (let n2 of (this.processedXData = this.xData, this.generatePoints(), P(s2.allDataPoints) || (s2.allDataPoints = this.accumulateAllPoints(), this.getPointRadius()), r2 ? i3 = s2.allDataPoints : (i3 = this.placeBubbles(s2.allDataPoints), this.options.draggable = false), i3))
              n2[3] === a2 && (t3 = o2[n2[4]], e3 = v(n2[2], void 0), r2 || (t3.plotX = n2[0] - s2.plotLeft + s2.diffX, t3.plotY = n2[1] - s2.plotTop + s2.diffY), C(e3) && (t3.marker = S(t3.marker, { radius: e3, width: 2 * e3, height: 2 * e3 }), t3.radius = e3));
        ...
        class p extends n {
          getGraphPath() {
            ...
            for (; e3--; )
              (e3 === t3.length || "M" === t3[e3][0]) && e3 > 0 && t3.splice(e3, 0, ["Z"]);
        ...
        return function(e3) {
          ...
          function o2() {
            return () => {
              if (this.isRadial && this.tickPositions && this.options.labels && true !== this.options.labels.allowOverlap)
                return this.tickPositions.map((t3) => this.ticks[t3] && this.ticks[t3].label).filter((t3) => !!t3);
            };
          }
          function x() {
            return n;
          ...
          function L(t3, e4, i3) {
            ...
            if ("polygon" === this.options.gridLineInterpolation)
              x2 = this.getPlotLinePath({ value: t3 }).concat(this.getPlotLinePath({ value: e4, reverse: true }));
            else {
          ...
          function C(t3) {
            ...
            if (d2 && (u2 = (M2 = this.getCrosshairPosition(t3, l2, h2))[0], k2 = M2[1], v2 = M2[2]), this.isCircular)
              f2 = Math.sqrt(Math.pow(k2 - l2, 2) + Math.pow(v2 - h2, 2)), b2 = "string" == typeof r2 ? m(r2, 1) : r2 / f2, y2 = "string" == typeof n2 ? m(n2, 1) : n2 / f2, e4 && c2 && (b2 < (g2 = c2 / f2) && (b2 = g2), y2 < g2 && (y2 = g2)), L2 = [["M", l2 + b2 * (k2 - l2), h2 - b2 * (h2 - v2)], ["L", k2 - (1 - y2) * (k2 - l2), v2 + (1 - y2) * (h2 - v2)]];
            else if ((u2 = this.translate(u2)) && (u2 < 0 || u2 > p2) && (u2 = 0), "circle" === this.options.gridLineInterpolation)
              L2 = this.getLinePath(0, u2, c2);
              ...
              for (let t4 = 0; t4 < S2.length; t4++)
                P2 = x2.getPosition(S2[t4], u2), L2.push(t4 ? ["L", P2.x, P2.y] : ["M", P2.x, P2.y]);
            }
            return L2;
          }
          function k(t3, e4) {
        ...
        function k() {
          if (this.chart.polar && this.xAxis) {
            ...
            for (; a2--; )
              this.is("column") || this.is("columnrange") || this.polar.toXY(o2[a2]), s2.hasParallelCoordinates || this.yAxis.reversed || (u(o2[a2].y, Number.MIN_VALUE) < i3.min || o2[a2].x < t3.min || o2[a2].x > t3.max ? (o2[a2].isNull = true, o2[a2].plotY = NaN) : o2[a2].isNull = o2[a2].isValid && !o2[a2].isValid());
        ...
        function N() {
          ...
          if (s2.isRadial)
            for (m2 = (g2 = this.points).length, y2 = o2.translate(o2.min), x2 = o2.translate(o2.max), c2 = t3.threshold || 0, i3.inverted && d(c2) && h(u2 = o2.translate(c2)) && (u2 < 0 ? u2 = 0 : u2 > p2 && (u2 = p2), this.translatedThreshold = u2 + l2); m2--; ) {
              if (A2 = (b2 = g2[m2]).barX, L2 = b2.x, C2 = b2.y, b2.shapeType = "arc", i3.inverted) {
                ...
                P2 = A2 + l2, b2.shapeArgs = this.polar.arc(b2.yBottom, b2.plotY, P2, P2 + b2.pointWidth), b2.shapeArgs.borderRadius = 0;
        ...
        function I(t3, e3, i3, s2) {
          ...
          if (this.chart.polar) {
            if (s2) {
              ...
              o2 = ["M", i3.plotX, i3.plotY];
          } else
            o2 = t3.call(this, e3, i3, s2);
          return o2;
        }
        ...
        return function(t3) {
          ...
          function h() {
            let t4 = this.axes;
            for (let e3 of this.series)
              if (e3.options.stacking) {
                for (let e4 of t4)
                  e4.isXAxis || (e4.waterfall.stacks.changed = true);
                break;
              }
          }
        ...
        class y extends a {
          ...
          processData(t3) {
            ...
            for (let t4 = 0; t4 < d2; t4++)
              r2 = l2[t4], e3 = h2 && h2[t4] ? h2[t4] : {}, "sum" === r2 || e3.isSum ? l2[t4] = p(s2) : "intermediateSum" === r2 || e3.isIntermediateSum ? (l2[t4] = p(i3), i3 = 0) : (s2 += r2, i3 += r2), o2 = Math.min(s2, o2), a2 = Math.max(s2, a2);
          ...
          getCrispPath() {
            ...
            for (let l2 = 1; l2 < i3; l2++) {
              if (!(this.options.connectNulls || u(this.data[t3[l2].index - 1].y)))
                continue;
              ...
              if (g2 && c2 && i4) {
                ...
                if (r2) {
                  ...
                  t4 = d(c2.y + (h2.minPointLengthOffset || 0), s2);
            ...
            let e3 = this.options, i3 = (_a = t3.waterfall) == null ? void 0 : _a.stacks, s2 = e3.threshold || 0, o2 = this.stackKey, a2 = this.xData, r2 = a2.length, n2 = s2, l2 = n2, h2, p2 = 0, d2 = 0, c2 = 0, u2, g2, f2, b2, m2, y2, x, P, S = (t4, e4, i4, s3) => {
              if (h2) {
                if (u2)
                  ...
                  h2.stackState[0] = t4, u2 = h2.stackState.length;
        ...
        return y.defaultOptions = g(a.defaultOptions, o), y.compose = i2.compose, c(y.prototype, { pointValKey: "y", showLine: true, pointClass: s }), n(y, "afterColumnTranslate", function() {
          ...
          for (let t4 = 0; t4 < e3.length; t4++) {
            ...
            if (r2) {
              ...
              p2 = Math.max(h2, h2 + L) + M[0], S.y = i3.translate(p2, false, true, false, true), b2.isSum ? (S.y = i3.translate(M[1], false, true, false, true), S.height = Math.min(i3.translate(M[0], false, true, false, true), i3.len) - S.y, b2.below = M[1] <= a2) : b2.isIntermediateSum ? (L >= 0 ? (y2 = M[1] + l2, x = l2) : (y2 = l2, x = M[1] + l2), i3.reversed && (y2 ^= x, x ^= y2, y2 ^= x), S.y = i3.translate(y2, false, true, false, true), S.height = Math.abs(S.y - Math.min(i3.translate(x, false, true, false, true), i3.len)), l2 += M[1], b2.below = y2 <= a2) : (S.height = P > 0 ? i3.translate(h2, false, true, false, true) - S.y : i3.translate(h2, false, true, false, true) - i3.translate(h2 - P, false, true, false, true), h2 += P, b2.below = h2 < a2), S.height < 0 && (S.y += S.height, S.height *= -1);
